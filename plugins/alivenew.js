...
┃◈└───────────┈⊷
┗━━━━━━━━━━━━━━𖣔𖣔
> ㋛︎ ᴘᴏᴡᴇʀᴅ ʙʏ  ᴍʀ  𝐃𝐈𝐋𝐒𝐇𝐀𝐍 𝐌𝐃
`;
        const aliveMessage = await conn.sendMessage(from, { 
            audio: { url: `https://github.com/MR-LAKSIDU/Gg/blob/main/Freebot.mp3?raw=true` }, 
            mimetype: "audio/mpeg",
            ptt: "true",
            contextInfo: {
                externalAdReply: {
                    ...
                    await conn.sendMessage(from, { 
                        ...
                        contextInfo: {
                            ...
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/gbyw4xfr/Xiao-Yi-Xian-battle-through-the-heavens.jpg',
...
`;
                    await conn.sendMessage(from, { 
                        audio: { url: `https://github.com/iohihfihsdifhdsfhdskhfppojojpjpjjpjjkpi/fgdsfgsdfasshhjhkjhxjkhxkhkhkxhkhxZKxhKhxKxhKhxkHxkhxkHxkHxkHxkHxkHxkhxkhxKxhKxhKxo-hiiiuiuifhjgfh/blob/main/WhatsApp%20Audio%202025-03-04%20at%207.36.09%20PM.mpeg?raw=true` }, 
                        mimetype: "audio/mpeg",
                        ptt: "true",
                        contextInfo: {
                            externalAdReply: {
                    ...
                    conn.ev.on('messages.upsert', async (menuUpdate) => {
                        ...
                        if (isReplyToMenuMsg) {
                            switch (menuMessageType) {
                                case '1':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/Hd2oHZj.jpeg` }, caption: menu1 }, { quoted: menuMek });
                                    break;
                                case '2':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/NQePzkt.jpeg` }, caption: menu2 }, { quoted: menuMek });
                                    break;
                                case '3':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/4xWTbBp.jpeg` }, caption: menu3 }, { quoted: menuMek });
                                    break;
                                case '4':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/7WLjd1C.jpeg` }, caption: menu4 }, { quoted: menuMek });
                                    break;
                                case '5':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/6Fqjtgh.jpeg` }, caption: menu5 }, { quoted: menuMek });
                                    break;
                                case '6':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/RwDtzh4.jpeg` }, caption: menu6 }, { quoted: menuMek });
                                    break;
                                case '7':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/P6jkQ0T.jpeg` }, caption: menu7 }, { quoted: menuMek });
                                    break;
                                case '8':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/l0xhYfq.jpeg` }, caption: menu8 }, { quoted: menuMek });
                                    break;
                                case '9':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/MZsPPKB.jpeg` }, caption: menu9 }, { quoted: menuMek });
                                    break;
                                case '10':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/SEuHUkq.jpeg` }, caption: menu10 }, { quoted: menuMek });
                                    break;
                                case '11':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/UWeRkvM.jpeg` }, caption: menu11 }, { quoted: menuMek });
                                    break;
                                case '12':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/yYR7Sd8.jpeg` }, caption: menu12 }, { quoted: menuMek });
                                    break;
                                case '13':
                                    await conn.sendMessage(menuFrom, { image: { url: `https://i.imgur.com/rbmSYsH.jpeg` }, caption: menu13 }, { quoted: menuMek });
                                    break;
                                default:
